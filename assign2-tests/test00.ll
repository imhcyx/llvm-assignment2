; ModuleID = '../assign2-tests/test00.bc'
...
define dso_local i32 @clever() #0 !dbg !16 {
  ...
  %name6 = call i32 @plus(i32 1, i32 2), !dbg !24
  call void @llvm.dbg.value(metadata i32 %name6, metadata !25, metadata !DIExpression()), !dbg !21
  ret i32 0, !dbg !27
}

; Function Attrs: nounwind readnone speculatable willreturn
declare void @llvm.dbg.value(metadata %name7, metadata %name8, metadata %name9) #1
...
!1 = !DIFile(filename: "test00.c", directory: "/home/free/workspace/compiler/assign2/assign2-tests")
!2 = !{}
