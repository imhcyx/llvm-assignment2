; ModuleID = '../assign2-tests/test10.bc'
...
; Function Attrs: nounwind readnone speculatable willreturn
declare void @llvm.dbg.value(metadata %name28, metadata %name29, metadata %name30) #1
...
!1 = !DIFile(filename: "test10.c", directory: "/home/free/workspace/compiler/assign2/assign2-tests")
!2 = !{}
