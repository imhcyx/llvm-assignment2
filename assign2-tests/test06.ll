; ModuleID = '../assign2-tests/test06.bc'
...
2:                                                ; preds = %1, %0
  %.0 = phi i32 (i32, i32)* [ @plus, %1 ], [ null, %0 ], !dbg !37
...
4:                                                ; preds = %3, %2
  %.1 = phi i32 (i32, i32)* [ @minus, %3 ], [ %.0, %2 ], !dbg !37
  call void @llvm.dbg.value(metadata i32 (i32, i32)* %.1, metadata !42, metadata !DIExpression()), !dbg !37
  %name20 = call i32 @clever(i32 %name14, i32 %name15, i32 (i32, i32)* %.1), !dbg !55
  call void @llvm.dbg.value(metadata i32 %name20, metadata !56, metadata !DIExpression()), !dbg !37
  ret i32 0, !dbg !58
}
...
!1 = !DIFile(filename: "test06.c", directory: "/home/free/workspace/compiler/assign2/assign2-tests")
!2 = !{}
