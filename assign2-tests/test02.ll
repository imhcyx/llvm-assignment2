; ModuleID = '../assign2-tests/test02.bc'
...
3:                                                ; preds = %2, %1
  %.0 = phi i32 (i32, i32)* [ @plus, %1 ], [ @minus, %2 ], !dbg !40
  call void @llvm.dbg.value(metadata i32 (i32, i32)* %.0, metadata !32, metadata !DIExpression()), !dbg !28
  %name11 = icmp ne i32 (i32, i32)* %.0, null, !dbg !41
  br i1 %name11, label %4, label %5, !dbg !43

4:                                                ; preds = %3
  %name12 = call i32 %.0(i32 1, i32 2), !dbg !44
  call void @llvm.dbg.value(metadata i32 %name12, metadata !46, metadata !DIExpression()), !dbg !48
  br label %5, !dbg !49
...
!1 = !DIFile(filename: "test02.c", directory: "/home/free/workspace/compiler/assign2/assign2-tests")
!2 = !{}
!3 = !{!4}
