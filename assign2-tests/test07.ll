; ModuleID = '../assign2-tests/test07.bc'
...
define dso_local i32 @moo(i8 signext %name13, i32 %name14, i32 %name15) #0 !dbg !32 {
  ...
  %name16 = sext i8 %name13 to i32, !dbg !47
  %name17 = icmp eq i32 %name16, 43, !dbg !49
  br i1 %name17, label %1, label %2, !dbg !50
...
3:                                                ; preds = %2, %1
  %.01 = phi i32 (i32, i32)* [ @plus, %1 ], [ @minus, %2 ], !dbg !53
  call void @llvm.dbg.value(metadata i32 (i32, i32)* %.01, metadata !42, metadata !DIExpression()), !dbg !37
  %name18 = icmp sgt i32 %name14, 0, !dbg !54
  br i1 %name18, label %4, label %5, !dbg !56

4:                                                ; preds = %3
  %name19 = call i32 @clever(i32 %name14, i32 %name15, i32 (i32, i32)* %.01), !dbg !57
  call void @llvm.dbg.value(metadata i32 %name19, metadata !45, metadata !DIExpression()), !dbg !37
  br label %6, !dbg !58

5:                                                ; preds = %3
  %name20 = call i32 @clever(i32 %name14, i32 %name15, i32 (i32, i32)* @plus), !dbg !59
  call void @llvm.dbg.value(metadata i32 %name20, metadata !45, metadata !DIExpression()), !dbg !37
  br label %6

6:                                                ; preds = %5, %4
  %.0 = phi i32 [ %name19, %4 ], [ %name20, %5 ], !dbg !60
  call void @llvm.dbg.value(metadata i32 %.0, metadata !45, metadata !DIExpression()), !dbg !37
  ret i32 %.0, !dbg !61
}
...
!1 = !DIFile(filename: "test07.c", directory: "/home/free/workspace/compiler/assign2/assign2-tests")
!2 = !{}
