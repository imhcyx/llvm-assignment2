; ModuleID = '../assign2-tests/test15.bc'
...
; Function Attrs: nounwind readnone speculatable willreturn
declare void @llvm.dbg.value(metadata %name18, metadata %name19, metadata %name20) #1
...
!1 = !DIFile(filename: "test15.c", directory: "/home/free/workspace/compiler/assign2/assign2-tests")
!2 = !{}
