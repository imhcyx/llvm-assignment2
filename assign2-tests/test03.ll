; ModuleID = '../assign2-tests/test03.bc'
...
2:                                                ; preds = %1, %0
  ...
  %name11 = icmp eq i32 %name9, 4, !dbg !40
...
4:                                                ; preds = %3, %2
  %.1 = phi i32 (i32, i32)* [ @minus, %3 ], [ %.0, %2 ], !dbg !28
  call void @llvm.dbg.value(metadata i32 (i32, i32)* %.1, metadata !32, metadata !DIExpression()), !dbg !28
  %name12 = icmp ne i32 (i32, i32)* %.1, null, !dbg !45
  br i1 %name12, label %5, label %6, !dbg !47

5:                                                ; preds = %4
  %name13 = call i32 %.1(i32 1, i32 2), !dbg !48
  call void @llvm.dbg.value(metadata i32 %name13, metadata !50, metadata !DIExpression()), !dbg !52
  br label %6, !dbg !53
...
; Function Attrs: nounwind readnone speculatable willreturn
declare void @llvm.dbg.value(metadata %name14, metadata %name15, metadata %name16) #1
...
!1 = !DIFile(filename: "test03.c", directory: "/home/free/workspace/compiler/assign2/assign2-tests")
!2 = !{}
!3 = !{!4}
