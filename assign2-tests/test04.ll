; ModuleID = '../assign2-tests/test04.bc'
...
; Function Attrs: nounwind readnone speculatable willreturn
declare void @llvm.dbg.value(metadata %name19, metadata %name20, metadata %name21) #1
...
!1 = !DIFile(filename: "test04.c", directory: "/home/free/workspace/compiler/assign2/assign2-tests")
!2 = !{}
!3 = !{!4}
